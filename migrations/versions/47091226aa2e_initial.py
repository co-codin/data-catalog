...
Revision ID: 47091226aa2e
Revises: 
Create Date: 2023-04-20 16:37:33.215664
...
def upgrade() -> None:
    ...
    sa.Column('synchronized_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
